	...
	<script>
		$('document').ready(function(){
			...
			$('#slc_sede').change(function() { 
				...
				if(sede){
					$.post('<?=base_url()?>index.php/carreras/habilitar/actualizar_detalle', {slc_sede : sede}, function (respuesta) {
...
<body>
	<?php
		...
		*/
		...
		$this->table->add_row(array('data' => $detalles, 'id' => 'detalles', 'colspan' => '2'));
