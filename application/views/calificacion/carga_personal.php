    	...
    	$(document).ready(function () {
		  ...
		  if ($("#mensaje").length > 0){
    		...
    		$('#btn_buscar').click(function() {
	    		...
	    		$.post('<?=base_url()?>index.php/calificacion/carga_personal/autocompletar_campos', {txt_documento : documento}, function (respuesta) {
//	    			alert(respuesta);
    		...
    		$('#slc_sede').change(function() {
    			documento = $('#txt_documento').val();
    			sede = $('#slc_sede').val();
	    		$.post('<?=base_url()?>index.php/calificacion/carga_personal/actualizar_slc_carrera', {txt_documento : documento, slc_sede : sede}, function (respuesta) {
					var datos = $.parseJSON(respuesta);
//					alert(respuesta);
					$('#slc_carrera').html(datos['carreras']);
					$('#slc_semestre').html(datos['semestres']);
    		...
    		$('#slc_carrera').change(function() {
	    		...
	    		$.post('<?=base_url()?>index.php/calificacion/carga_personal/actualizar_slc_semestre', {slc_sede : sede, slc_carrera : carrera, txt_documento : documento}, function (respuesta) {
    		...
    		$('#slc_semestre').change(function() {
	    		...
	    		$.post('<?=base_url()?>index.php/calificacion/carga_personal/cargar_detalles', {slc_sede : sede, slc_carrera : carrera, slc_semestre : semestre, txt_documento : documento}, function (respuesta) {
//	    			alert(respuesta)
    		...
    		$('#btn_cancelar').click(function() {
    			...
    			$.post('<?=base_url()?>index.php/calificacion/carga_personal/cancelar', function (r) {
	    			alert(r)
    			})	    		
    		});
	});
...
<?php
	echo form_open();
		echo form_fieldset('Carga de calificación');
