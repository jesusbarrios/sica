	...
	<script>
		$('document').ready(function(){
			...
			$('#slc_semestre').change(function(args) {
				...
				cantidad_curso_correlativo_actual = $('#slc_semestre_correlativo option').length - 1;
				semestre_seleccionado = $('#slc_semestre').val();
				
				$('#lista').hide('fast');

				if(cantidad_curso_correlativo_actual < semestre_seleccionado){
					for(i = cantidad_curso_correlativo_actual; i < semestre_seleccionado; i ++){
