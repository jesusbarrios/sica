...
<body>
	<?php
		...
		foreach($sub_menus as $row)
			...
			$this->table->add_row($contador++, $row->menu_detalle, $row->posicion, ($row->estado == '0')? 'Desactivado' : 'Activado', '<a href=' . base_url() . 'menu/sub_menu/delete/' . $row->id_menu_detalle . '>borrar</a>');
